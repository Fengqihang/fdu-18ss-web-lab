    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              foreach ($countries as $country=>$country_value){
                  echo"<a href='list.php?country=$country_value' role='button' class='btn btn-default'>$country_value</a>";
              }
              ?>
		...
		<ul class="caption-style-2">
          ...
          foreach ($images as $image=>$image_value) {
              ...
              <img src='images/square/".$image_value['path']."' alt='".$image_value['description']."'>
                 <div class='caption'>
                       <div class='blur'></div>
